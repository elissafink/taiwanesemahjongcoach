  ...
  const GameTable = ({ compact, mode }) => (
    <div style={{
      ...
      <div style={{ display: "flex", gap: compact ? 4 : 8, alignItems: "flex-start" }}>
        ...
        {/* Center discard — tiles capped, last 4 log entries always visible */}
        <div style={{
          flex: 1,
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 2, alignContent: "flex-start", maxHeight: compact ? 80 : 110, overflow: "hidden" }}>
          ...
          <div style={{ background: "rgba(0,0,0,0.3)", borderRadius: 4, padding: "3px 6px", border: `1px solid ${COLORS.border}` }}>
