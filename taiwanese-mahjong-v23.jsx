...
export default function MahjongApp() {
  ...
  const sendChatMessage = async (question) => {
    ...
    const { revealed, discardPile, discardPiles, playerWinds, flowers, drawnTile } = game;
...
- Chow = claim sequence from left player's discard. Pong = claim triplet from any player's discard.
    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: compact ? 4 : 8, alignItems: "stretch", height: compact ? 160 : 190 }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, display: "flex", flexWrap: "wrap", gap: 2, alignContent: "flex-start", overflow: "hidden", minHeight: 0 }}>
